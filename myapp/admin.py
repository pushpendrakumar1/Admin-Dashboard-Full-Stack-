...
from myapp.models import log_history
...
class tool_l(admin.ModelAdmin):

    list_display = ('output_file','uploaded_file','processed_file','date_modified')    
...
admin.site.register(log_history, tool_l)
